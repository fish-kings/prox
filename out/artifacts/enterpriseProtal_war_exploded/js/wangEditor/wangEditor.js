...
Video.prototype = {
    ...
    _createPanel: function _createPanel() {
        ...
        var _editor$config = this.editor.config,
            _editor$config$insert = _editor$config.insertIframeVideo,
            insertIframeVideo = _editor$config$insert === undefined ? true : _editor$config$insert,
            customUploadVideo = _editor$config.customUploadVideo;
        // 创建 id
        ...
        var tabsConfig = [{
            title: '上传视频',
            tpl: '<div class="w-e-up-img-container">\n                    <div id="' + upTriggerId + '" class="w-e-up-btn">\n                        <i class="w-e-icon-upload2"></i>\n                    </div>\n                    <div style="display:none;">\n                        <input id="' + upFileId + '" type="file" multiple="multiple" accept=".mp4,.avi,.mkv,.wmv,.swf,.flv"/>\n                    </div>\n                </div>',
            events: [{
                // 触发选择视频
...
UploadVideo.prototype = {
    ...
    insertLinkVideo: function insertLinkVideo(link) {
        ...
        editor.cmd.do('insertHTML', '<video controls src="' + link + '" style="max-width:100%;"/>');
    },
    ...
    uploadVideo: function uploadVideo(files) {
        ...
        var maxSizeM = maxSize / 1024 / 1024;
        var maxLength = config.uploadVideoMaxLength || 10;
        ...
        arrForEach(files, function (file) {
            ...
            if (/\.(mp4||avi|mkv|wmv|swf|flv)$/i.test(name) === false) {
                // 后缀名不合法，不是视频
